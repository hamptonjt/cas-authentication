/**
 * Appalachian Login script to work with EIS single-signon (CAS) - Modified version of passport-cas npm library
 * Author:  HAMPTONJT
 * Date:    2/15/2017
 */
var url = require('url')
...
Strategy.prototype.authenticate = function (req, options) {
  ...
  // JTH - Adding EIS certificates
  rootCas
    .inject()
    .addFile('./certs/chain.crt')
    .addFile('./certs/eis-dev-1.its.appstate.edu.crt')
    .addFile('./certs/chain_prod.crt')
    .addFile('./certs/eis-prd-1_its_appstate_edu.crt')
  ...
  var get = this.client.get({
    ...
    ca: rootCas,
    path: url.format({
      pathname: '/cas/validate', // JTH - changed this to include '/cas' at the beginning of the path...
      query: {
        ticket: ticket,
